...
- The AI basket has outperformed the S&P 500 by **15.6 points** over the trailing year, but even an 11-name basket spanning chips, cloud, software, and datacenter infrastructure is still a concentration bet: **NVDA alone accounts for 40% of its combined trading volume.**
