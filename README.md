...
<!-- KEY_FINDINGS_START -->
- The AI basket has outperformed the S&P 500 by **+60.8 points** over the trailing year (+81.8% vs. +21.0%). The spread is up 1.4pts versus last week's 59.4pts (2026-08-31).
- Routine day-to-day AI-sector search attention shows no reliable link to stock moves (strongest lag correlation only +0.15), but the biggest attention spikes show a **+6.0-point** swing between the return before and after each one. That swing is flat versus last week's 6.0pts (2026-08-31).
- **NVDA** still accounts for **29%** of the AI basket's trading volume, though the basket-wide Herfindahl index of 1278 is now unconcentrated overall. NVDA's share is down 0.1% versus last week's 29.5% (2026-08-31).
- **10 of 11** sectors fell on rising-yield days and rallied on falling-yield days as expected, with XLE the exception. The count following the pattern is flat versus last week's 10 sectors (2026-08-31).
- Realized volatility peaked at **1.3%** on 2026-04-09 and has since eased to **0.57%** as of the latest reading. The latest reading is down 0.03% versus last week's 0.60% (2026-08-31).
- The infrastructure names added to the AI basket returned **+120.1%** on an equal-weighted basis versus **+41.8%** for the original core cohort, though 3 of those infrastructure names are actually down over the same window. The gap is flat versus last week's 78.3pts (2026-08-31).
<!-- KEY_FINDINGS_END -->
