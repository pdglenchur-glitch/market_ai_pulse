...
- The AI basket has outperformed the S&P 500 by **61.9 points** over the trailing year (+79.8% vs. +17.9%), driven substantially by explosive moves in AI-memory and AI-power names like Micron and Bloom Energy. NVDA is still the single largest contributor to basket trading volume at **32%**, but across all 17 names the basket has moved from highly concentrated to unconcentrated by a standard Herfindahl measure.
