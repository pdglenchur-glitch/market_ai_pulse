...
**The only genuinely open item left in the whole project** is the historical-depth question: how much history to retain for trend charts (e.g., cap at a 1-year rolling window, or let it grow unbounded). Not urgent — irrelevant until months of daily history accumulate.
